...
def play_funny(indent=0):
    data = json.loads(content)
    print("Really? You actually want me to do that?")
    confirm = input("Press ENTER if you really, actually, genuinely, unironically want me to do that. ")
    if(confirm == ""):
        time.sleep(0.7)
        print("Well, only because you asked so nicely... :)")
        time.sleep(0.5)
        print("Just give me one sec...")
        time.sleep(2.5)
        print("\nHere you go! :D\n")
        time.sleep(0.005)
